    ...
    private List<Filter> initFilters(DataSourceProperty dataSourceProperty, String filters) {
        ...
        if (!StringUtils.isEmpty(filters)) {
            ...
            if (filters.contains("log4j")) {
                proxyFilters.add(DruidLogConfigUtil.initFilter(Log4jFilter.class, dataSourceProperty.getDruid().getSlf4j(), gConfig.getSlf4j()));
            }
            if (filters.contains("log4j2")) {
                proxyFilters.add(DruidLogConfigUtil.initFilter(Log4j2Filter.class, dataSourceProperty.getDruid().getSlf4j(), gConfig.getSlf4j()));
            }
        }
